            ...
            <form action={{route('admin.add_package')}} method="post" >
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="service_name_one"
                            placeholder="Name of service"  value="{{old("service_name_one")}}"/>
                        @error('service_name')
                        <p class="error-text">{{$message}}</p>
                        @enderror
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="service_name"
                            placeholder="Name of service"  value="{{old("service_name_two")}}"/>
                        @error('service_name_two')
                        <p class="error-text">{{$message}}</p>
                        @enderror
                    </label>
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="service_name_three"
                            placeholder="Name of service"  value="{{old("service_name_three")}}"/>
                        @error('service_name_three')
                        <p class="error-text">{{$message}}</p>
                        @enderror
                    </label>
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="service_name_four"
                            placeholder="Name of service"  value="{{old("service_name_four")}}"/>
                        @error('service_name_four')
                        <p class="error-text">{{$message}}</p>
                        @enderror
                    </label>
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            name="service_name_five"
                            placeholder="Name of service"  value="{{old("service_name_five")}}"/>
                        @error('service_name_four')
                        <p class="error-text">{{$message}}</p>
                        @enderror
                    </label>
