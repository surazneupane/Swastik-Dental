    ...
    @section('body')
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container px-6 mx-auto grid">
                ...
                <form action="/admin/add/staff" method="post" enctype="multipart/form-data">
                    @csrf
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Add Staff</h2>
                    <!-- CTA -->
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <label class="text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Upload Staff Image</span>
                        </label>
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <textarea
                                ...
                                rows="3"
                                name="about"
                                placeholder="About Staff" value="{{old("about")}}"
                            ></textarea>
                            @error('description')
                            <p class="error-text">{{$message}}</p>
                            @enderror
                        ...
                        <label class="block text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="twitter"
                                placeholder="Twitter link" value="{{old("twitter")}}" type="url"/>
                            @error('twitter')
                            <p class="error-text">{{$message}}</p>
                            @enderror
                        ...
                        <label class="block text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="facebook"
                                placeholder="Facebook Link" value="{{old("facebook")}}" type="url"/>
                            @error('facebook')
                            <p class="error-text">{{$message}}</p>
                            @enderror
                        ...
                        <label class="block text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="instagram"
                                placeholder="Instagram" value="{{old("instagram")}}" type="url"/>
                            @error('instagram')
                            <p class="error-text">{{$message}}</p>
                            @enderror
