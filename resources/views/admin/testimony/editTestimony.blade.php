...
@section('body')
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <form action="/admin/testimony/edit/{{$testimony->id}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Edit Testimony Of:{{$testimony->name}}</h2>
                @php
