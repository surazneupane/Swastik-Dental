                ...
                <div class="row slider-text align-items-end">
                    <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                        <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span
                                class="mr-2"><a href="{{route('public.index')}}">Home</a></span> <span>Blog</span></p>
                    ...
                    <div class="row">
                        <div class="col-md-12 ftco-animate">
                            <div class="blog-entry">
                                <a href="{{route('public.blog','url')}}" class="block-20"
                                    style="background-image: url('/public/images/image_1.jpg');">
                                </a>
                                <div class="text d-flex py-4">
                                    ...
                                    <div class="desc pl-sm-3 pl-md-5">
                                        ...
                                        <p><a href="{{route('public.blog','url')}}" class="btn btn-primary btn-outline-primary">Read
                                                more</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 ftco-animate">
                            <div class="blog-entry" data-aos-delay="100">
                                <a href="{{route('public.blog','url')}}" class="block-20"
                                    style="background-image: url('/public/images/image_2.jpg');">
                                </a>
                                <div class="text d-flex py-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">Sep. 20, 2018</a></div>
                        ...
                        <div class="col-md-12 ftco-animate">
                            <div class="blog-entry" data-aos-delay="200">
                                <a href="{{route('public.blog','url')}}" class="block-20"
                                    style="background-image: url('/public/images/image_3.jpg');">
                                </a>
                                <div class="text d-flex py-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">Sep. 20, 2018</a></div>
                        ...
                        <div class="col-md-12 ftco-animate">
                            <div class="blog-entry">
                                <a href="{{route('public.blog','url')}}" class="block-20"
                                    style="background-image: url('/public/images/image_4.jpg');">
                                </a>
                                <div class="text d-flex py-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">Sep. 20, 2018</a></div>
                        ...
                        <div class="col-md-12 ftco-animate">
                            <div class="blog-entry" data-aos-delay="100">
                                <a href="{{route('public.blog','url')}}" class="block-20"
                                    style="background-image: url('/public/images/image_5.jpg');">
                                </a>
                                <div class="text d-flex py-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">Sep. 20, 2018</a></div>
                        ...
                        <div class="col-md-12 ftco-animate">
                            <div class="blog-entry" data-aos-delay="200">
                                <a href="{{route('public.blog','url')}}" class="block-20"
                                    style="background-image: url('/public/images/image_6.jpg');">
                                </a>
                                <div class="text d-flex py-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">Sep. 20, 2018</a></div>
